...
public class EmployeeRoleControllerTest {
    ...
    public void a_create() {
        ...
        ResponseEntity<EmployeeRole> postResponse = testRestTemplate.getRestTemplate().postForEntity(baseURL + "/create", employeeRole, EmployeeRole.class);
    ...
    public void e_delete() {
        String empId = null;
        EmployeeRole employeeRole = testRestTemplate.getForObject(baseURL + "/employeeRole//" + empId, EmployeeRole.class);
        assertNotNull(employeeRole);
